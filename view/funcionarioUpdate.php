    ...
    <div class="container">
        ...
        <form action="../controller/funcionarioController.php" method="POST">
            <div class="form-group">
                ...
                <br>
                <input type="text" id="fun_nome" name="fun_nome" required value="<?php echo $funcionario['fun_nome'];?>">
            </div>
            <div class="form-group">
                <label for="fun_descricao">Senha:</label>
                <br>
                <input type="text" id="fun_senha" name="fun_senha" required value="<?php echo $funcionario['fun_senha'];?>">
            </div>
